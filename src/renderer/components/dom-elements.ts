...
export const getRendererElements = () => ({
  ...
  siriInfoPanel: requireElement<HTMLDivElement>("#siriInfoPanel"),
  siriModeLabel: requireElement<HTMLSpanElement>("#siriModeLabel"),
  siriVoiceLevel: requireElement<HTMLElement>("#siriVoiceLevel"),
  siriUserText: requireElement<HTMLParagraphElement>("#siriUserText"),
  siriReplyText: requireElement<HTMLParagraphElement>("#siriReplyText"),
  ...
  appleMusicKeyNameInput: requireElement<HTMLInputElement>("#appleMusicKeyNameInput"),
  appleMusicTeamIdInput: requireElement<HTMLInputElement>("#appleMusicTeamIdInput"),
  appleMusicKeyIdInput: requireElement<HTMLInputElement>("#appleMusicKeyIdInput"),
  appleMusicPrivateKeyPathInput: requireElement<HTMLInputElement>("#appleMusicPrivateKeyPathInput"),
  saveAppleMusicConfigBtn: requireElement<HTMLButtonElement>("#saveAppleMusicConfigBtn"),

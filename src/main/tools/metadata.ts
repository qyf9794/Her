...
export const allToolDefinitions = [
  ...
  },
  {
    ...
    description: "Create or overwrite a .txt or .md file under an allowlisted folder such as Desktop, Documents, or Downloads. Requires explicit confirmation.",
    parameters: objectSchema(
      {
        path: { type: "string", description: "Target .txt or .md path under an allowlisted folder, for example ~/Desktop/summary.md." },
        content: { type: "string", description: "Complete file content to write." },
        overwrite: { type: "boolean", default: false, description: "If false, HER refuses to overwrite an existing file." },
      },
      ["path", "content"],
    ),
  },
...
export const toolSchemas: Record<ToolName, z.ZodTypeAny> = {
  ...
  file_write_text: z.object({ path: z.string().min(1), content: z.string(), overwrite: z.boolean().optional().default(false) }),
...
export const toolRiskOverrides: Partial<Record<ToolName, ToolRisk>> = {
  ...
  window_hide_all: "local_open",
  window_minimize_all: "local_open",
  window_auto_arrange: "local_open",
  window_minimize_unrelated: "local_open",
  window_close: "local_open",
  window_minimize: "local_open",
  window_maximize: "local_open",
  window_move_resize: "local_open",
